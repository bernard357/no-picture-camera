# How to contribute to the No-picture Camera project?
...
Initially the No-picture Camera project has been initiated so that as many
people as possible can play with smart cameras powered by Raspberry Pi boards and connected over LoRa technology. There is so much to learn in these domains!
...
that are used by people you dare. Lead them to play with the No-picture Camera too!
...
[Provide feedback right now](https://github.com/bernard357/smart-video-counter/issues)
...
[Project bugs and issues](https://github.com/bernard357/smart-video-counter/issues)
...
[Project primary documentation](https://github.com/bernard357/smart-video-counter/tree/master/docs)
...
1. From [the project page at GitHub](https://github.com/bernard357/smart-video-counter), you can [fork it](https://help.github.com/articles/fork-a-repo/) so that you have your own project space.
...
8. All [Pull Requests are listed from the original project page](https://github.com/bernard357/smart-video-counter/pulls)
...
Look through [the GitHub issues](https://github.com/bernard357/smart-video-counter/issues) for bugs.
Anything tagged with "bug" is open to whoever wants to implement it.

## How to implement new features?

Look through [the GitHub issues](https://github.com/bernard357/smart-video-counter/issues) for features.
